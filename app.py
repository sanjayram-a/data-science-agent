...
from llama_index.llms.gemini import Gemini # Use LlamaIndex's Gemini integration
...
with st.sidebar.container():
    ...
    if gemini_api_key and not st.session_state.llm:
        try:
            ...
            Settings.llm = Gemini(model_name="models/gemini-2.0-flash", api_key=gemini_api_key)
